...
function getRandomFilePath() {
  ...
  return `../lyd-intervaller-c-samtidig/${String(randomIndex).padStart(2, '0')}.flac`;
}
...
function playCurrentSound() {
  ...
  if (currentAnswer === null) {
    ...
    const filePath = `../lyd-intervaller-c-samtidig/${String(currentAnswer).padStart(2, '0')}.flac`;
    const audio = new Audio(filePath);
    audio.play();
  }
}
